  ...
  return (
    <div className="mt-12 grid md:grid-cols-3 gap-6">
      <div className="text-center">
        ...
        <p className="text-gray-700 text-sm">WebP images load up to 30% faster than traditional formats</p>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-700 text-sm">Reduce file sizes by 25-35% without quality loss</p>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-700 text-sm">Maintain excellent image quality with modern compression</p>
      </div>
    </div>
  );
};
